# Email OpenAPI Specification
[![Build Status](https://travis-ci.org/cosmostail/doc.svg?branch=master)](https://travis-ci.org/cosmostail/doc)
...
6. If you did everything correct, https://cosmostail.github.io/doc/ will lead to your new docs
...
- Documentation(ReDoc): https://cosmostail.github.io/doc/
- SwaggerUI: https://cosmostail.github.io/doc/swagger-ui/
- Look full spec:
    + JSON https://cosmostail.github.io/doc/swagger.json
    + YAML https://cosmostail.github.io/doc/swagger.yaml
- Preview spec version for branch `[branch]`: https://cosmostail.github.io/doc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://cosmostail.github.io/doc/ with url from the message: `Server started <url>`
